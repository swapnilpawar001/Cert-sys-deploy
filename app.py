...
class CertificateWebApp:
    ...
    def initialize_components(self):
        ...
        try:
            ...
            print(f"📄 Checking template path: {self.template_path}")
            print(f"📁 Checking output directory: {self.output_dir}")
            
            # Check if template exists with detailed info
            if os.path.exists(self.template_path):
                template_size = os.path.getsize(self.template_path)
                print(f"✅ Certificate template found: {template_size} bytes")
                ...
                print("❌ Certificate template not found at expected path")
            ...
            print(f"✅ Certificate output directory created/verified")
